...
__hanabi.watch(() => {
  ...
  // KissKH files anime under /Drama/ too, so the path can't tell anime from
  // drama — default everything to the K-drama collection and move the occasional
  // anime by hand. (See README: "K-Dramas (reclassify if needed)".)
